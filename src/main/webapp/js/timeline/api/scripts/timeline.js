...
Timeline._Band = function(timeline, bandInfo, index) {
    ...
    this._openBubbleListeners = [];
    this._closeBubbleListeners = [];
...
Timeline._Band.prototype.addOpenBubbleListener = function(listener) {
    this._openBubbleListeners.push(listener);
};

Timeline._Band.prototype.addCloseBubbleListener = function(listener) {
    this._closeBubbleListeners.push(listener);
};
...
Timeline._Band.prototype.openBubbleForPoint = function(pageX, pageY, width, height) {
    ...
    this._bubble = Timeline.Graphics.createBubbleForPoint(
        this._timeline.getDocument(), pageX, pageY, width, height, function(){
        	band._fireOnBubbleClosed();
        });
    
    this._fireOnBubbleOpened();
...
Timeline._Band.prototype._fireOnBubbleOpened = function() {
    for (var i = 0; i < this._openBubbleListeners.length; i++) {
        this._openBubbleListeners[i](this);
    }
};

Timeline._Band.prototype._fireOnBubbleClosed = function() {
    for (var i = 0; i < this._closeBubbleListeners.length; i++) {
        this._closeBubbleListeners[i](this);
    }
};
